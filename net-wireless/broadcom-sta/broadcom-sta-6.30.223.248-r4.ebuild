...
src_prepare() {
	epatch \
		...
		"${FILESDIR}/${PN}-6.30.223.248-debian-07-fix_procfs_handling.patch" \
		"${FILESDIR}/${PN}-6.30.223.248-debian-08-enable_error_traces.patch" \
		"${FILESDIR}/${PN}-6.30.223.248-debian-09-fix_system_hang_when_deleting_monitor.patch"
